...
//     const handleScroll = () => {
//       if (bgRef.current) {
//         // Move the background at 50% scroll speed
//         bgRef.current.style.transform = `translateY(${window.scrollY * 0.5}px)`;
//       }
//     };
...
//       >
//         {/* Darker Green Overlay Gradient */}
//         <div className="absolute inset-0 bg-gradient-to-t from-black/50 via-emerald-900/70 to-transparent" />
//       </div>

//       {/* Content */}
//       <div className="relative z-10 container mx-auto px-4 text-center animate-fade-in">
//         {/* Tagline Chip */}
//         <div className="inline-flex items-center gap-2 px-5 py-2 bg-emerald-700/60 backdrop-blur-md border border-emerald-500/40 rounded-full text-white text-sm font-semibold mb-6">
//           <span className="w-2 h-2 bg-emerald-400 rounded-full animate-pulse" />
//           Welcome to Runner City Housing
//         </div>
...
//         <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold text-white mb-6 leading-tight tracking-tight">
//           Smarter Living
//           <span className="block bg-gradient-to-r from-white/90 to-emerald-300/80 bg-clip-text text-transparent">
//             Together
//           </span>
//         </h1>
